...
import { Banco } from '../formPlanilla/form-planilla/modeloPlanilla/Banco';
import { ArchivoNBRequest } from '../formPlanilla/form-planilla/modeloPlanilla/ArchivoNBRequest';
...
export class PlanillaComponent implements OnInit {
    ...
    */
    ...
    mostrarCargarHoras() {
        this.router.navigate(['/cargarHX']);
    }

    mostrarDeducciones() {
        this.router.navigate(['/deduccion-carga']);
    }
