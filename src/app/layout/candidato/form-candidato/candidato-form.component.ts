...
export class CandidatoComponent implements OnInit {
    ...
    Buscar() {
        ...
        this.servicioPlanilla.obtenerEmpleados(formEmpleado).subscribe((data) => {
            this.listaEmpleados = data;
        });
    }
    ...
    asignarCandidato(emp: Candidato) {
        ...
        console.log('EMPLEADO ASIGNAR:' + JSON.stringify(this.candidatoSeleccionado));
        ...
        // console.log('**********>>>SEXO EMPLEADO'+this.candidatoSeleccionado.sexo);
        this.empForm.get('sexo').setValue(1);

        /*if (this.candidatoSeleccionado.sexo) {
           this.empForm.get('sexo').setValue(Number(this.candidatoSeleccionado.sexo));
        }*/
...
*/
    ...
    public cambiarFotoEmpleado(event) {
        ...
        reader.onload = () => {
            ...
            this.empleadoSelecionado.archivoFoto = archivo;
